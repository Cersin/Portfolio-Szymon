<template>
  <section class="about">
    <div class="about_description">
      ...
      <p>Moim głównym zainteresowaniem jest tworzenie stron internetowych i aplikacji mobilnych. Pragnę nieustannie
    ...
    <div class="about_technologies">
      <a aria-label="Vue" class="about_technologies-svg" href="https://vuejs.org/">
      ...
      <a aria-label="Node" class="about_technologies-svg" href="https://nodejs.org/en/">
        <svg xmlns="http://www.w3.org/2000/svg" version="1.2" viewBox="0 0 442.37 270.929">
          <defs>
            <clipPath id="a">
              <path
      ...
      <a aria-label="Nativescript" class="about_technologies-svg" href="https://nativescript.org/">
      ...
      <a aria-label="Sass" class="about_technologies-svg" href="https://sass-lang.com/">
        <svg aria-hidden="true" focusable="false" data-prefix="fab" data-icon="sass"
             class="svg-inline--fa fa-sass fa-w-20" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512">
          <path fill="#CD6799"
    ...
    <TheArrow :goto="'#portfolio'" class="arrow"></TheArrow>
  </section>
</template>
